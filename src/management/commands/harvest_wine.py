...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        exceptions.add('http://www.joshlikeswine.com/2013/06/15/wset-diploma-section-1-week-10/')
        exceptions.add('http://www.joshlikeswine.com/2014/07/31/wine-bloggers-conference-2014-the-back-of-the-bottle-the-odds-and-ends/')

        no_wine = set()
        no_wine.add('http://www.joshlikeswine.com/2013/06/15/wset-diploma-section-1-week-10/')
        no_wine.add('http://www.joshlikeswine.com/2014/07/31/wine-bloggers-conference-2014-the-back-of-the-bottle-the-odds-and-ends/')
        ...
        for url in posts:
            ...
            if url in exceptions:
                ...
                if is_tasting:
                    ...
                    # Todo: Need to get this to break on posts that have no wines in them that are still going to match the results regex
                    if results:
